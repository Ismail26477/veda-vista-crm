...
import { LeadStage, LeadPriority, LeadStatus } from '@/types/crm';
...
export const StatusBadge = ({ status, size = 'md' }: StatusBadgeProps) => {
  const statusConfig: Record<LeadStatus, { label: string; className: string }> = {
    ...
    not_interested: { label: 'Not Interested', className: 'bg-destructive/10 text-destructive border border-destructive/20' },
  };
